	...
	public KeyGenerator keyGenerator() {
		return new KeyGenerator() {
			...
			public Object generate(Object o, Method method, Object... objects) {
				StringBuilder sb = new StringBuilder(SysConstants.CACHE_NAMESPACE);
				...
				if (cacheConfig != null && sb.toString().equals(SysConstants.CACHE_NAMESPACE)) {
					String[] cacheNames = cacheConfig.cacheNames();
					if (cacheNames != null && cacheNames.length > 0) {
						sb.append(cacheNames[0]);
					}
				}
				if (sb.toString().equals(SysConstants.CACHE_NAMESPACE)) {
