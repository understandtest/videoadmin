...
import com.videoadmin.annotation.ControllerLog;
import com.videoadmin.annotation.ServiceLog;
...
public class LogAop {
     ...
     * @see
     */
    @Pointcut("@annotation(com.taohua.annotation.ControllerLog)")
     ...
     * @see
     */
    @Pointcut("@annotation(com.taohua.annotation.ServiceLog)")
